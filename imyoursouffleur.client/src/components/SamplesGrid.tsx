...
const SamplesGrid: React.FC<SamplesGridProps> = ({ onSynchronisationClick, onCoachClick, onRapportClick, onPhotosClick, onConclusionClick, isOnline }) => {
    const samples = [
        ...
        { title: 'Photos', description: 'Ajouter les photos et commentaires si nécessaire', buttonLabel: 'Photos', disabled: false },
        ...
        { title: 'Cloture', description: 'Termine tes dossiers de la journée en les re synchronisant', buttonLabel: 'Fin de journée', disabled: !isOnline }
    ];
